...
function calculateLoan () {
   ...
   document.querySelector('#totalAmount').innerText = 'totalAmount: ₹' + totalAmount.toFixed(2);
   document.querySelector('#totalInterest').innerText = 'totalInterest: ₹' + totalInterest.toFixed(2);
}